...
float sineWave( float time, float amplitude, float frequency, float phase, float offset = 0.0, float deadband_low = 0.0, float deadband_high = 0.0); //TODO: hide this function in the .h file
