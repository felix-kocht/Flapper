...
const HX711Params cell_2_params = {4,5, 9999, 1};
const HX711Params cell_3_params = {6,7, 9999, 1};
const HX711Params cell_4_params = {8,9, 9999, 1};
const HX711Params cell_5_params = {10,11, 9999, 1};
...
void loop() {
  ...
  float valuesToPrint[] = {readings[0][0]*10, readings[1][0]*10, readings[2][0]*10, readings[3][0]*10, readings[4][0]*10};
